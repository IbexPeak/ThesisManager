namespace ThesisManager.Web.Attributes {
    ...
    /// <summary>
    ///     Attribute, dass für einen Request zunächst überprüft, ob der Nutzer angemeldet ist und anschließend überprüft ob
    ///     der Nutzer authorisiert ist.
    ...
    public class AuthenticateAndAuthorizeAttribute : AuthorizeAttribute {
        protected override void HandleUnauthorizedRequest(AuthorizationContext filterContext) {
            if (filterContext.HttpContext.Request.IsAuthenticated) {
                throw new HttpException((int)HttpStatusCode.Forbidden, "Keine Autorisierung!");
            } else {
                throw new HttpException((int)HttpStatusCode.Unauthorized, "Keine Authentifizierung!");
            }
